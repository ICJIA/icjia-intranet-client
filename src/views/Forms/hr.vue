        ...
        <v-col>
          <v-card class="py-5 px-5 mt-5">
            <v-container>
              <v-row>
                <v-col cols="12" class="text-center">
                  <h1 class="mb-6">Contact Human Resources</h1>
                </v-col>
              </v-row>
            </v-container>
            <form style="margin-top: 0px">
              ...
              >
                <b style="font-size: 20px">CONTACT HR REQUEST NOT SENT</b>
                <br />
                <br />
                {{ axiosError }}
              </div>
    ...
    async submit() {
      ...
      if (this.isSuccess) {
        ...
        let options = {
          method: "POST",
          data: this.form,
          url: "https://mail.icjia.cloud/intranet/hr",
        };
